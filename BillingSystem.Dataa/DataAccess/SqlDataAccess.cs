...
namespace BillingSystem.Dataa.DataAccess;
...
public class SqlDataAccess : ISqlDataAccess
{
    ...
    public async Task<T> SaveDataAndGet<T, P>(string spName, P parameters, string connectionId = "conn")
    {
        using IDbConnection connection = new SqlConnection(_config.GetConnectionString(connectionId));
        return await connection.QuerySingleAsync<T>(spName, parameters, commandType: CommandType.StoredProcedure);
    }
